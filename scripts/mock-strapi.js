...
const MOCK_PRODUCTS = [
  {
    ...
    images: [{ id: 1, documentId: 'img-1', url: 'https://placehold.co/400x400', alternativeText: 'MacBook', width: 400, height: 400, formats: null }],
  ...
  },
  {
    ...
    images: [{ id: 2, documentId: 'img-2', url: 'https://placehold.co/400x400', alternativeText: 'Headphones', width: 400, height: 400, formats: null }],
    category: MOCK_CATEGORY,
